...
ALTER TABLE PRODUCTS 
DROP CONSTRAINT FK_PRODUCT_CATEGORY;  -- 기존 외래키 제약조건 삭제

ALTER TABLE PRODUCTS 
ADD CONSTRAINT FK_PRODUCT_CATEGORY FOREIGN KEY (CATEGORY_ID) REFERENCES CATEGORY (CATEGORY_ID) ON DELETE SET NULL;  -- 외래키 재설정, 비식별관계로 설정
...
VALUES (1, '청바지', 'img/jeans1.jpg', 'img/jeans2.jpg', NULL, '스타일리시한 청바지', 40000, 50, SYSDATE, '브랜드B', '판매중');
